                    ...
                    <div className='p-5 py-3 white-bg-section'>
                        ...
                        <div className='text-center'>
                            ...
                            <div className='px-4 mt-1'>
                                <p className='small-fonts description'>Members enjoy special pricing so leave the chores to us.</p>
                            </div>
                            <button className='rounded-pill btn btn-outline btn-chores'>See Chores</button>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className='p-5 py-3 rating-section'>
                        ...
                        <div className='text-center white-clr'>
                            ...
                            <div className='mt-2 small-fonts'>
                                <p className='mb-0'>This saves me hundreds each month, easily. It's the best amenity I've ever had.</p>
